        ...
        <div>
            ...
            <div className="ContactPage">
                ...
                <div className="contact-sect">
                    <ContactItem icon={phone} text1={'+48 795 844 548'} title={'Phone'}/>
                    <ContactItem icon={email} text1={'dimka8445484@gmail.com'} title={'Email'}/>
                    <ContactItem icon={location} text1={'Gdansk'} text2={'Poland'} title={'Address'}/>
                </div>
            </div>
        </div>
    )
